...
if not TOKEN:
    raise Exception(
        "\u274c \u0412 .env \u0434\u043e\u043b\u0436\u0435\u043d \u0431\u044b\u0442\u044c TELEGRAM_TOKEN"
    )
...
if not ENCRYPTION_KEY:
    raise Exception(
        "\u274c \u0412 .env \u0434\u043e\u043b\u0436\u0435\u043d \u0431\u044b\u0442\u044c ENCRYPTION_KEY"
    )
...
def add(message):
    ...
    bot.send_message(
        message.chat.id,
        "\u270d\ufe0f \u041e\u0442\u043f\u0440\u0430\u0432\u044c \u0441\u0435\u043a\u0440\u0435\u0442 \u0438 \u043f\u043e\u0434\u043f\u0438\u0441\u044c \u0432 \u043e\u0434\u043d\u043e\u0439 \u0441\u0442\u0440\u043e\u043a\u0435:\n`JBSWY3DPEHPK3PXP GitHub`",
        parse_mode="Markdown",
    )
...
def delete_key(message):
    ...
    for idx, entry in enumerate(user_data[chat_id]):
        markup.add(
            InlineKeyboardButton(f"\u274c {entry['label']}", callback_data=f"del_{idx}")
        )
    bot.send_message(
        message.chat.id,
